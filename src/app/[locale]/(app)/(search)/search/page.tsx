...
const PageSearch = async ({
  ...
  const sortByOptions = [
    { name: t('mostRecent'), value: 'most-recent' },
    { name: t('curatedByAdmin'), value: 'curated-by-admin' },
    { name: t('mostAppreciated'), value: 'most-appreciated' },
    { name: t('mostDiscussed'), value: 'most-discussed' },
    { name: t('mostViewed'), value: 'most-viewed' },
    { name: t('mostLiked'), value: 'most-liked' },
  ]
  const filterTabs = [
    {
      name: t('articles'),
